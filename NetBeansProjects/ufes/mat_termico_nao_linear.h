 ...
 ***************************************************************************/
#ifndef MAT_TERMICO_NAO_LINEAR_H
#define MAT_TERMICO_NAO_LINEAR_H
...
*/
class mat_termico_nao_linear : public material
{
protected:
   const static int nprp=2;  //Numero de propriedades
public:
    mat_termico_nao_linear();
