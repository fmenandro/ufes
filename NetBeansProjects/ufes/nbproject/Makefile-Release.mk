...
${OBJECTDIR}/aleatorio.o: aleatorio.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/aleatorio.o aleatorio.cpp

${OBJECTDIR}/analise.o: analise.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/analise.o analise.cpp

${OBJECTDIR}/analise_incremental.o: analise_incremental.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/analise_incremental.o analise_incremental.cpp

${OBJECTDIR}/analise_termica.o: analise_termica.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/analise_termica.o analise_termica.cpp

${OBJECTDIR}/barra1d.o: barra1d.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/barra1d.o barra1d.cpp

${OBJECTDIR}/barra2d.o: barra2d.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/barra2d.o barra2d.cpp

${OBJECTDIR}/barra3d.o: barra3d.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/barra3d.o barra3d.cpp

${OBJECTDIR}/c_contorno.o: c_contorno.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/c_contorno.o c_contorno.cpp

${OBJECTDIR}/elcal1d2n.o: elcal1d2n.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/elcal1d2n.o elcal1d2n.cpp

${OBJECTDIR}/elcal2d4n.o: elcal2d4n.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/elcal2d4n.o elcal2d4n.cpp

${OBJECTDIR}/elcal2d4nnl.o: elcal2d4nnl.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/elcal2d4nnl.o elcal2d4nnl.cpp

${OBJECTDIR}/elcal2d8n.o: elcal2d8n.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/elcal2d8n.o elcal2d8n.cpp

${OBJECTDIR}/elemento.o: elemento.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/elemento.o elemento.cpp

${OBJECTDIR}/elemento2d3n.o: elemento2d3n.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/elemento2d3n.o elemento2d3n.cpp

${OBJECTDIR}/elemento2d4n.o: elemento2d4n.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/elemento2d4n.o elemento2d4n.cpp

${OBJECTDIR}/elemento2d8n.o: elemento2d8n.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/elemento2d8n.o elemento2d8n.cpp

${OBJECTDIR}/elemento2d9n.o: elemento2d9n.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/elemento2d9n.o elemento2d9n.cpp

${OBJECTDIR}/elemento3d.o: elemento3d.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/elemento3d.o elemento3d.cpp
...
${OBJECTDIR}/iscal1d.o: iscal1d.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/iscal1d.o iscal1d.cpp

${OBJECTDIR}/iscal2d.o: iscal2d.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/iscal2d.o iscal2d.cpp

${OBJECTDIR}/isop2d.o: isop2d.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/isop2d.o isop2d.cpp

${OBJECTDIR}/mat_linear_elastico.o: mat_linear_elastico.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/mat_linear_elastico.o mat_linear_elastico.cpp

${OBJECTDIR}/mat_termico.o: mat_termico.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/mat_termico.o mat_termico.cpp

${OBJECTDIR}/mat_termico_nao_linear.o: mat_termico_nao_linear.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/mat_termico_nao_linear.o mat_termico_nao_linear.cpp
...
${OBJECTDIR}/mef.o: mef.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/mef.o mef.cpp

${OBJECTDIR}/nlcal2d4n.o: nlcal2d4n.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/nlcal2d4n.o nlcal2d4n.cpp
...
${OBJECTDIR}/no1d.o: no1d.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/no1d.o no1d.cpp

${OBJECTDIR}/no2d.o: no2d.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/no2d.o no2d.cpp

${OBJECTDIR}/no3d.o: no3d.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/no3d.o no3d.cpp

${OBJECTDIR}/tubo.o: tubo.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tubo.o tubo.cpp

${OBJECTDIR}/ufesApp.o: ufesApp.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ufesApp.o ufesApp.cpp

${OBJECTDIR}/ufesMain.o: ufesMain.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ufesMain.o ufesMain.cpp

${OBJECTDIR}/viga2d.o: viga2d.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/viga2d.o viga2d.cpp

${OBJECTDIR}/viga3d.o: viga3d.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/viga3d.o viga3d.cpp
